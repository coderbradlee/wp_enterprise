...
function mytheme_move_opion($wp_customize){
	  ...
	  $wp_customize->add_section('mytheme_detects_scheme', array(
       ...
       'description' => ' <strong>这个选项只有付费版才会有效，你现在可以查看下面的选项了解一些可以设置的功能，付费版可以独立设置移动端的样式、排版，你可以访问WEB主题公园的官网，使用手机扫描二维码查看付费版的样式：</strong></br>  <a href="http://www.themepark.com.cn/tyqywordpresszt.html" target="_blank">前往付费版了解详细</a>  </br>',
        'priority' => 79,
    ));
