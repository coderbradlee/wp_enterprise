...
function mytheme_initialization_options($wp_customize){
	 ...
	 $wp_customize->add_setting('mytheme_donghuaopen', array(
        'default'        => '',
        'capability'     => 'edit_theme_options',
        'type'           => 'option',
 
    ));	
 $wp_customize->add_control('mytheme_donghuaopen', array(
        'label'      => __('内容区动画开关', 'donghuaopen'),
        'section'    => 'mytheme_initialization_options',
        'settings'   => 'mytheme_donghuaopen',
		'type'    => 'select',
		 'choices'    => array(
            '' => '默认默认开启动画',
            'none' => '关闭动画',
 ...
 $wp_customize->add_control('mytheme_enter_p', array(
	...
	$wp_customize->add_setting('mytheme_qh_btn', array(
	    'default'        => '#f5f5f5',
        'sanitize_callback' => 'sanitize_hex_color',
        'capability'        => 'edit_theme_options',
        'type'           => 'option',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_qh_btn', array(
        'label'    => __('正文切换按钮背景色', 'extraordinaryvision'),
        'section'  => 'mytheme_initialization_options',
        'settings' => 'mytheme_qh_btn',
    )));	
   
	
		$wp_customize->add_setting('mytheme_qh_btn1', array(
	    'default'        => '#98d000',
        'sanitize_callback' => 'sanitize_hex_color',
        'capability'        => 'edit_theme_options',
        'type'           => 'option',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_qh_btn1', array(
        'label'    => __('正文切换按钮颜色', 'extraordinaryvision'),
        'section'  => 'mytheme_initialization_options',
        'settings' => 'mytheme_qh_btn1',
    )));	
   
   
   
   $wp_customize->add_setting('mytheme_qh_btn2', array(
	    'default'        => '#768e02',
        'sanitize_callback' => 'sanitize_hex_color',
        'capability'        => 'edit_theme_options',
        'type'           => 'option',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_qh_btn2', array(
        'label'    => __('正文切换按钮选中状态颜色', 'extraordinaryvision'),
        'section'  => 'mytheme_initialization_options',
        'settings' => 'mytheme_qh_btn2',
    )));	
   
	
	 $wp_customize->add_setting('mytheme_qh_btn3', array(
	    'default'        => '#ffffff',
        'sanitize_callback' => 'sanitize_hex_color',
        'capability'        => 'edit_theme_options',
        'type'           => 'option',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_qh_btn3', array(
        'label'    => __('正文切换按钮文字颜色', 'extraordinaryvision'),
        'section'  => 'mytheme_initialization_options',
        'settings' => 'mytheme_qh_btn3',
    )));
};
