...
class pic_two extends WP_Widget {
	...
	function form($instance) { 
		 ...
		 $zhiding4 = esc_attr($instance['zhiding4']);
		  ...
		  $post_nunberk = esc_attr($instance['post_nunberk']);
		  $post_nunberk2 = esc_attr($instance['post_nunberk2']);
		  $post_nunberk3 = esc_attr($instance['post_nunberk3']);
...
$pos5_excerpt=95;$pos5_excerpt2=65; 
 ?>
<div class="three_mode_go in_mode <?php echo $this->get_field_id("id"); ?>">
     ...
     <div class="three_mode_go_mode ">
       ...
       <ul>
         ...
         <li class="info_pic_s">
                                     ...
                                     <a class="info_pic_s_tt"  title="<?php the_title();?>" href="<?php the_permalink() ?>" target="_blank"><?php  echo mb_strimwidth(strip_tags(apply_filters('the_title', $tit)),  0,40,"...",'utf-8'); ?></a>
        ...
        <?php }else{ ?>
          ...
          <li class="info_pic_s three_mode_small">
                                     ...
                                     <strong>
                                     <a  title="<?php the_title();?>" href="<?php the_permalink() ?>" target="_blank"><?php  echo mb_strimwidth(strip_tags(apply_filters('the_title', $tit)),  0,30,"...",'utf-8'); ?></a>
                                     </strong>
                                      <p> <?php echo mb_strimwidth(strip_tags(apply_filters('the_excerp',get_the_excerpt($id))),0,$pos5_excerpt2,"...",'utf-8'); ?></p>
                                     </li>
                                     
                                       <?php }elseif($show_way_center==2){
					     	if($ashu_i==1){ ?>                       
                             <li class="info_hot">
          ...
          <?php }}elseif($show_way_center==3){ ?>
		  
		  
          <li class="three_mode_allpic <?php if($ashu_i==2||$ashu_i==4){echo ' three_mode_allpic_margin'; }?>">
            <a title="<?php the_title();?>" class="three_mode_allpic_out"href="<?php the_permalink() ?>" target="_blank">
                                <?php   themepark_thumbnails('case'); ?> 
            </a>
            <a href="<?php the_permalink() ?>" target="_blank" class="three_mode_allpic_title" >  <?php  echo mb_strimwidth(strip_tags(apply_filters('the_title', $tit)),  0,30,"...",'utf-8'); ?>   
             </a>
          </li>
...
<script> $(window).scroll(function () {$(".donghuaopen .<?php echo $this->get_field_id("id"); ?>").news();}); </script>
