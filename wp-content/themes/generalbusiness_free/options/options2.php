...
【选择分类目录模板的功能是付费版的内容，你可以升级付费版解锁这个功能，<a target="_blank" href="http://www.themepark.com.cn/tyqywordpresszt.html"> 查看付费版详情</a>】</p>
              ...
              <em> 若设置了这个选项，首页的产品模块会出现绿色按钮，按钮会统一跳转上面填写的链接，你可以填写一个qq弹出链接，注意需要填写弹出链接，或者联系我们的页面链接【付费版可以分别设定单篇文章这个按钮的链接，<a target="_blank" href="http://www.themepark.com.cn/tyqywordpresszt.html"> 查看付费版详情</a>】</em>
            </div>          
           ...
           <div class="xiaot">
            ...
            <p><strong>在首页、侧边栏和列表页有的列表会调用一个封面图片，如果没有设置，而你的文章中也没有图片，那么将会调用一张默认的图片，你可以在此处上传各个尺寸的默认图片【一些尺寸可能只能用在首页，付费版的尺寸可以用在内页的模板中，<a target="_blank" href="http://www.themepark.com.cn/tyqywordpresszt.html"> 查看付费版详情</a>】。</strong></p>
