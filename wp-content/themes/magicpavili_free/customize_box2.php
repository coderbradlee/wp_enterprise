...
function new_customize_box2() {
  ...
  <div style=" width:100%; padding:10px 0;display:inline-block;overflow: hidden; text-align:center;">
      <a target="_blank" href="http://www.themepark.com.cn/mszgwordpressqyzt.html"><img style="max-width:100%; height:auto;" src="<?php echo get_bloginfo('template_url').'/images/magicpavilion_zhemepark_wordpress_theme.jpg'; ?>" /></a>
      <p>感谢使用WEB主题公园出品的免费主题，若觉得好用可以直接升级付费版，付费版可以继承免费版的绝大部分设置。</p> 
      <a class="button" href="http://www.themepark.com.cn/mszgwordpressqyzt.html" target="_blank">点击查看</a>
...
echo '    
  <div style=" width:100%; padding:10px 0;display:inline-block;overflow: hidden; text-align:center;">
      <a target="_blank" href="http://www.themepark.com.cn/mszgwordpressqyzt.html"><img style="max-width:100%; height:auto;" src=" '.get_bloginfo('template_url').'/images/magicpavilion_zhemepark_wordpress_theme.jpg" /></a>
      <p>感谢使用WEB主题公园出品的免费主题，若觉得好用可以直接升级付费版，付费版可以继承免费版的绝大部分设置。</p> 
      <a class="button" href="http://www.themepark.com.cn/mszgwordpressqyzt.html" target="_blank">点击查看</a>
...
function example_add_dashboard_widgets() {
    wp_add_dashboard_widget('custom_help_widget', '关注WEB主题公园', 'custom_dashboard_help');
}
