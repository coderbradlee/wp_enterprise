...
$customize_title = sprintf( __( 'Customize &#8220;%s&#8221;' ), $ct->display('Name') );
 ?>
        <p><b>主题名称：<?php echo $ct->display('Name'); ?></b> <a class="banben">版本：<?php echo $ct->display('Version'); ?></a>
         <a  href="http://www.themepark.com.cn/mszgwordpressmfzttyb.html" target="_blank" class="jieshao">详细介绍</a> 
        <a href="http://www.themepark.com.cn/?s=%E9%AD%94%E6%9C%AF%E5%B1%95%E9%A6%86&cat=7,8,56" target="_blank" class="bangzhu">教程和其他版本</a></p>
        <p><b>主题出品：</b><a target="_blank" href="http://www.themepark.com.cn"><?php echo $ct->display('Author'); ?></a>  <a href="http://www.themepark.com.cn/mszgwordpressmfzttyb.html" target="_blank">正版用户可以享受后台一键自动更新（仪表盘-->更新检查）</a></p>
