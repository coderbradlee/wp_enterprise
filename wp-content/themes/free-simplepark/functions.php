<?php
 require 'theme-updates/theme-update-checker.php';
	    $example_update_checker = new ThemeUpdateChecker(	
		 'free-simplepark', 
         'http://www.themepark.com.cn/free_themes/free-simplepark/free-simplepark.json'  //info.json 的访问地址
);
...
array(
'header-menu' => __( '菜单导航' ),
'prodct-menu' => __( '产品分类菜单（多层）' ),
'footer-menu1' => __( '底部双层导航' ),
'footer-menu2' => __( '底部单层导航' ),
'link-menu2' => __( '友情链接' )
)
);
...
if ( function_exists( 'add_image_size' ) ) {
    ...
    add_image_size( 'news_smoll-sidbar-thumb', 111, 111,true );
	  add_image_size( 'footer-small-thumbb', 64,64,true );
	    add_image_size( 'default-list-thumbb', 130,130,true );
		  ...
		  add_image_size( 'hot-pic-thumbb', 1920,526,true );
