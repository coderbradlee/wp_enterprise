...
require_once("lib-direct/alipay_notify.class.php");
?>
<!DOCTYPE HTML>
<html>
    <head>
...
?>
    ...
    <body>
        ...
        <table align="center" width="350" cellpadding="5" cellspacing="0">
            <tr>
                <td align="center" class="font_title" colspan="2"><strong>付款结果，如果你已经付款成功，页面没有显示成功，请联系客服</strong></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="font_content" align="left"><?php if($_GET['trade_status']== 'TRADE_SUCCESS'||$_GET['trade_status']== 'WAIT_SELLER_SEND_GOODS'){echo "支付成功";} ?></td>
            </tr>
        </table>
    </body>
</html>