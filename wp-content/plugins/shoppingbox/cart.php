 ...
 <p class="pay_title">结算列表</p>
   ...
   <em><a class="delit" href="<?php echo get_page_link( $shop_profile ).$cart_url.$delit.$value->alipay_num;;  ?>">删除订单</a></em>
       ...
       <div class="order_more">
            ...
            <p>单价：￥<?php echo ($totalprice/$alipay_nmbers)-$postage; ?>  |  数量：<?php echo $alipay_nmbers; ?>  |  邮费￥：<?php echo $postage ?>    |  下单时间:  <?php echo $value->alipay_time; ?>   <br />总价：<strong class="red"> ￥<?php echo $totalprice; ?></strong>[含邮费]   </p>
