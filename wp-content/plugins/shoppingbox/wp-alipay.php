...
$gotoalipay='$("#post_buy_cart").submit();';
		...
		if($pay_way_p=='cod'){ $shop_pay_wayss='<a class="choseed" id="cod_go"></a>';}
        if($pay_way_p=='alipay'||!$pay_way_p){ $shop_pay_wayss='<a id="alipay_go" class="choseed"></a>';}
		if($pay_way_p=='all'||!$pay_way_p){ $shop_pay_wayss='<a id="alipay_go" class="choseed"></a><a  id="cod_go"></a>';}
		 
		 
		 $chosepay='<div class="pay_way_box"><label>支付方式:</label>'.$shop_pay_wayss.'</div>';
		 $chosepay_script='
